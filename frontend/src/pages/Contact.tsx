...
export function Contact() {
  ...
  function handleSend() {
    ...
    window.location.href = `mailto:support@trackvibe.org?subject=${mailSubject}&body=${mailBody}`;
  }
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:support@trackvibe.org"
